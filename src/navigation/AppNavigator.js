...
function HomeStackNavigator() {
  ...
  return (
    ...
    >
      ...
      {/* 👤 🛠️ ফিক্স ১: হোম পেজের প্রোফাইল বাটনের টার্গেট নাম 'ProfileScreenView' করে দেওয়া হলো যাতে ট্যাবের নামের সাথে নাগোলায় */}
      <Stack.Screen name="ProfileScreenView" component={ProfileScreen} options={{ title: "My Profile" }} />
    </Stack.Navigator>
  );
}
...
export default function AppNavigator() {
  const isAuthenticated = useSelector((state) => state.auth.isAuthenticated);
  console.log("authnavigation",isAuthenticated);
  ...
  return (
    ...
    >
        ...
        {/* 👤 🛠️ ফিক্স ২: মেইন ট্যাবটির নাম 'ProfileTab' রাখা হলো কনফ্লিক্ট এড়ানোর জন্য */}
        <Tab.Screen
            name="ProfileTab"
